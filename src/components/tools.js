...
const Tools = () => {
    ...
    return (
        <div className="development-tools">
            ...
            <div className="tools">
                <div className="vsCode tools-div" data-aos="flip-down" data-aos-delay="200">
                ...
                <div className="vsCodeExt tools-div" data-aos="flip-down" data-aos-delay="400">
                    <h3><VscExtensions /></h3>
                ...
                <div className="codePen tools-div" data-aos="flip-down" data-aos-delay="600">
                    <h3><SiCodepen /></h3>
