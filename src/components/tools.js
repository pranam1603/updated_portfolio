...
const Tools = () => {
    ...
    return (
        <div className="development-tools">
            ...
            <div className="tools">
                <div className="vsCode tools-div" data-aos="flip-down" data-aos-delay="100">
                ...
                <div className="vsCodeExt tools-div" data-aos="flip-down" data-aos-delay="100">
                    <h3><VscExtensions /></h3>
                ...
                <div className="codePen tools-div" data-aos="flip-down" data-aos-delay="100">
                    <h3><SiCodepen /></h3>
