        ...
        <>
            <div className="singleBlog-1">
                <div className="singleblog-header">
                    <img src="https://plus.unsplash.com/premium_photo-1664476845274-27c2dabdd7f0?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt='stock' />
                </div>
                <main id="single-Blog">

                    <div className="singleBlog-body">
                        <h1>Trading as a career</h1>
                        <p>
                        ...
                        <p>You just need a PC or a phone and you are ready to make your career as a stock trader. These are just the physical asset which one should have to trade properly but most importantly your discipline, risk management and perfect trading setup make you successful one . You can treat it like business or hobby if you treat it like business so it will pay you like business or treat it like hobby it will pay you like hobby.</p>
