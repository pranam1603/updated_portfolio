        ...
        <>
            <div className="singleBlog-1">
                <div className="singleblog-header">
                    <img src="https://images.unsplash.com/photo-1556761175-5973dc0f32e7?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt='stock' />
                </div>
                <main id="single-Blog">
                    ...
                    <div className="singleBlog-body">
                        ...
                        <img className='blogpage2-noteimg' style={{ marginTop: '20px' }} src={image} alt="startupimage" />
